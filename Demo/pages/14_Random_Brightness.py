...
st.set_page_config(page_title="Random Brightness Demo", page_icon="📈")

st.markdown("# Random Brightness")
...
limit = st.sidebar.slider('Factor range for changing brightness?', 0.0, 3.0, value=1.75)
